(() => {
  ...
  },
  {
    ...
    "age": "6さい",
    "type": "うとうとコアラ",
    "personality": "ねむそうだけど いざというときは しっかり みまもってくれる。",
    "skill": "やさしく みまもること",
    "favorite": "ユーカリ",
    "join": "⭐25こで なかま",
    "blurb": "おひるねじょうずな コアラ。",
  ...
  },
  {
    ...
    "age": "6さい",
    "type": "ぷにぷにアザラシ",
    "personality": "ほわんと していて いやしけい。みんなが つかれると ほっぺを すりっと してくれる。",
    "skill": "いやしパワー",
    "favorite": "つめたい みず",
    "join": "⭐37こで なかま",
    "blurb": "まるい ほっぺの アザラシ。",
  ...
  },
  {
    ...
    "age": "？",
    "type": "ひかるクリスタル",
    "personality": "ことばは すくないけれど ぴかっと ひかって おうえんしてくれる。",
    "skill": "ひらめきチャージ",
    "favorite": "きれいな ひかり",
    "join": "⭐67こで なかま",
    "blurb": "ひかりを あつめる ふしぎな こ。",
    "art": "creature",
    "species": "crystal",
    "accent": "#9fd6ff",
    "accent2": "#effaff",
  ...
  },
  {
    ...
    "age": "6さい",
    "type": "ももいろガール",
    "personality": "あかるくて おしゃれずき。じぶんの だいすきな リボンで みんなを げんきづける。",
    "skill": "かわいいポーズ",
    "favorite": "ももジュース",
    "join": "⭐69こで なかま",
    "blurb": "ももいろ えがおの かわいい こ。",
    "art": "creature",
    "species": "peach",
    "accent": "#ffb4c8",
    "accent2": "#fff0f5",
  ...
  function isCharacterUnlocked(c) {
    if (c.id === 'iroha') return state.stars >= c.unlockStars && (state.stageScores['b2']?.rating || 0) >= 1;
    return state.stars >= c.unlockStars;
  }
  ...
  function getUnlockedCollections() {
    return COLLECTIONS.filter(isCharacterUnlocked);
  }

  function renderCompanions() {
    const unlocked = shuffle(getUnlockedCollections());
    const party = unlocked.slice(0, Math.min(6, unlocked.length));
  ...
  function renderCollection() {
    ...
    if (summary) {
      summary.innerHTML = `<div class="collection-summary-card"><div><span>あつめた なかま</span><strong>${unlockedIds.size} / ${COLLECTIONS.length}</strong></div><div><span>レア</span><strong>${rareCount} / 1</strong></div><div><span>あそびかた</span><strong>⭐を あつめると なかまが ふえるよ</strong></div></div>`;
    }
