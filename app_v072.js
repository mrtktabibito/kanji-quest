(() => {
  ...
  function openCompanionProfile(id) {
    ...
    openModal(profile.name, `
      <div class="companion-profile ${profile.id === 'iroha' ? 'iroha-profile' : ''}">
        ${hero}
        ...
        <div class="companion-profile-info">
          <div class="profile-mini"><span>ねんれい</span><strong>${profile.age}</strong></div>
          <div class="profile-mini"><span>とくい</span><strong>${profile.skill}</strong></div>
          <div class="profile-mini profile-favorite"><span>すき</span><strong>${profile.favorite}</strong></div>
          <div class="profile-wide"><span>しょうかい</span><strong>${profile.blurb}</strong></div>
          <div class="profile-wide"><span>なかま</span><strong>${profile.join}</strong></div>
        </div>
      </div>`);
  }
